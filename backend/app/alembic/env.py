"""The Melvin Alembic environment.

This module provides Alembic configuration to manage database schema migrations.
"""
...
# Importall models so they're available for the auto-generation
